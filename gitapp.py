...
st.write("""
# Structural Geology Practical NoteBook WebApp - Made by ⓒNiladri Das
Author: Niladri Das \U0001F60F \U0001F60E
...
#d3 = Aerial distance of Lowest Point from Highest Point
    ...
    Maz_deg=st.number_input('Azimuth of Medium Point with Highest point (in degrees)')
    Laz_deg=st.number_input('Azimuth of Lowest Point with Highest point (in degrees)')
...
###########################################################################################################
    ...
    st.write("""
                ##### •Instructions: Enter strike value that is towards left the dip direction 
            """)
    st.write("""
                ###### •Sample question:
            """)
